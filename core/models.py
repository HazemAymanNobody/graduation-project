...
class Product(models.Model):
    ...
    old_price = models.DecimalField(max_digits=12,decimal_places=2, default="19.99")
...
class CartOrder(models.Model):
    ...
    paid_status = models.CharField(choices=PAYMENT_STATUS, max_length=30, default='pending')
    ...
    payment_method = models.CharField(max_length=100, default='cash_on_delivery')
...
class CartOrderItem(models.Model):
    ...
    qty = models.IntegerField(default=0, validators=[MinValueValidator(1)])
    price = models.DecimalField(max_digits=12, decimal_places=2, default="9.99")
    total = models.DecimalField(max_digits=12, decimal_places=2, default="9.99")
...
class Address(models.Model):
    aid = ShortUUIDField(unique=True, length=10, max_length=20, prefix='add', alphabet='abcdefgh12345')
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
